...
from anonymnet.utils.general import Path, download, np, xyxy2xywhn
...
animals_categories_ids = [341, 342, 344, 318, 300, 295, 240, 180, 178, 144, 324, 323, 307, 330, 103, 326, 311, 320, 273]
...
for split, patches in [("val", 43 + 1), ("train", 50 + 1)]:
    ...
    if split == "train":
        ...
        download([f"{url}patch{i}.tar.gz" for i in range(patches)], dir=tmp_images, curl=True, delete=True, threads=1)
    elif split == "val":
